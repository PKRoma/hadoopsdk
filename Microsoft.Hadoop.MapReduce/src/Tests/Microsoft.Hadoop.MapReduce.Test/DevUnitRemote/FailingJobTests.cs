...
namespace Microsoft.Hadoop.MapReduce.Test.DevUnitRemote
{
    ...
    public class FailingJobTests
    {
        ...
        public void JobFailureMashalTest()
        {
            ...
            HdfsFile.WriteAllText(inputPath, "dummytext");
            HadoopJobExecutor.Execute<BadMapper>(new HadoopJobConfiguration { InputPath = inputPath, OutputFolder = outputFolder });
        }
