...
namespace Microsoft.Hadoop.MapReduce.Test
{
    ...
    static class SimpleJobExecutor
    {
        ...
        {
            return Execute<TInput, TMapKey, TMapValue>(input, () => HadoopJobExecutor.Execute<TMapper, IdentityReducer<TMapKey, TMapValue>>(Configuration), out counters);
        }
        ...
        {
            return Execute<TInput, TReduceKey, TReduceValue>(input, () => HadoopJobExecutor.Execute<IdentityMapper<TInput>, TReducer>(Configuration), out counters);
        }
        ...
        {
            return Execute<TInput, TReduceKey, TReduceValue>(input, () => HadoopJobExecutor.Execute<TMapper, TReducer>(Configuration), out counters);
        }
        ...
        {
            return Execute<TInput, TReduceKey, TReduceValue>(input, () => HadoopJobExecutor.Execute<TMapper, TReducer, TCombiner>(Configuration), out counters);
        }
        ...
        {
            HdfsFile.WriteAllText(InputPath, String.Join("\n", input));
            ...
            if (consoleOutput.Contains("Streaming Job Failed!"))
            {
                ...
                Console.WriteLine("All logs:\r\n" +
                    String.Join("\r\n",
                        HdfsFile.EnumerateDataInFolder(
