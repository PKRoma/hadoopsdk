...
namespace HiveSample
{
    ...
    {
        public MyHiveDatabase(string hostName, int port) : base(hostName, port, null, null) { }

        public MyHiveDatabase(string hostName, int port, string username, string password) : base(hostName, port, username, password) { }
