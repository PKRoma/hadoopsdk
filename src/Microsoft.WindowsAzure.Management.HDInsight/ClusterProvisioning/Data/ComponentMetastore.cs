namespace Microsoft.WindowsAzure.Management.HDInsight.ClusterProvisioning.Data
{
    ...
    /// </summary>
    public class ComponentMetastore
    {
        /// <summary>
        /// Gets the server.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the ComponentMetastore class.
        /// </summary>
        ...
        public ComponentMetastore(string server, string database, string user, string password)
        {
            this.Server = server;
