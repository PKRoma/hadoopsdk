namespace Microsoft.WindowsAzure.Management.HDInsight.ClusterProvisioning.Data
{
    ...
    /// </summary>
    public class HDInsightMetastore
    {
        /// <summary>
        /// Gets the server.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the HDInsightMetastore class.
        /// </summary>
        ...
        public HDInsightMetastore(string server, string database, string user, string password)
        {
            this.Server = server;
