...
namespace Microsoft.Hadoop.Avro.Specifications
{
    ...
    public sealed class AvroContainerTests
    {
        ...
        public void Container_SerializeHugeObject()
        {
            ...
            var writer = AvroContainer.CreateWriter<SimpleFlatClass>(this.resultStream, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, Codec.Null);
            ...
            this.resultStream.Seek(0, SeekOrigin.Begin);
            var reader = AvroContainer.CreateReader<SimpleFlatClass>(this.resultStream, true, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, new CodecFactory());
            reader.MoveNext();
            Assert.IsTrue(expected.SequenceEqual(reader.Current.Objects));
        }
        ...
        public void Container_Reset()
        {
            ...
            {
                var writer = AvroContainer.CreateWriter<ClassOfListOfGuid>(memoryStream, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, Codec.Deflate);
                ...
                var reader = AvroContainer.CreateReader<ClassOfListOfGuid>(memoryStream, true, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, new CodecFactory());
        ...
        {
            var serializer = AvroSerializer.Create<ClassOfInt>(new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) });
            ...
            using (var memoryStream = new MemoryStream())
            {
                ...
                var reader = AvroContainer.CreateReader<ClassOfInt>(memoryStream, true, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, new CodecFactory());
                var actual = new List<ClassOfInt>();
                while (reader.MoveNext())
                {
                    actual.AddRange(reader.Current.Objects);
        ...
        public void Container_MicrosoftWriterApacherReaderOfNestedType()
        {
            ...
            using (var memoryStream = new MemoryStream())
            {
                var writer = AvroContainer.CreateWriter<NestedClass>(memoryStream, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, Codec.Deflate);
        ...
        public void Container_CreateReaderWithNullStream()
        {
            using (AvroContainer.CreateReader<int>(null))
            {
            }
        }
        ...
        [TestCategory("CheckIn")]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Container_WriterWithNullStream()
        {
            using (AvroContainer.CreateWriter<int>(null, Codec.Deflate))
            {
            }
        }
        ...
        [TestCategory("CheckIn")]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Container_CreateWriterWithNullCodec()
        {
            using (AvroContainer.CreateWriter<int>(this.resultStream, null))
            {
            }
        }
        ...
        [TestCategory("CheckIn")]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Container_CreateWriterWithNullMetadata()
        {
            using (var s = AvroContainer.CreateWriter<int>(this.resultStream, Codec.Deflate))
            {
                s.SetMetadata(null);
        ...
        public void Container_SchemaEvolution_RecordContainingArrayWithWriterIntPromotedToReaderLong()
        {
            ...
            using (var memoryStream = new MemoryStream())
            {
                var writer = AvroContainer.CreateGenericWriter<AvroRecord>(WriterSchema, memoryStream, Codec.Null);
                ...
                var reader = AvroContainer.CreateGenericReader<AvroRecord>(ReaderSchema, memoryStream, true, new CodecFactory());
            ...
            @"{
                 ...
                 ""fields"":
                           [
                                ...
                                {""name"": ""classField"", ""type"" : [ ""null"", ""Microsoft.Hadoop.Avro.Specifications.WriterClass""] },
