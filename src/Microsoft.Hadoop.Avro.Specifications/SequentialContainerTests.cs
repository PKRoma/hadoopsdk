...
namespace Microsoft.Hadoop.Avro.Specifications
{
    ...
    public sealed class SequentialContainerTests
    {
        ...
        public void SequentialReaderWriter_SerializeHugeObject()
        {
            ...
            var w = AvroContainer.CreateWriter<SimpleFlatClass>(this.resultStream, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, Codec.Null);
            ...
            this.resultStream.Seek(0, SeekOrigin.Begin);
            var r = AvroContainer.CreateReader<SimpleFlatClass>(this.resultStream, true, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, new CodecFactory());
        ...
        public void SequentialReader_ApacheWriterMicrosoftReader()
        {
            ...
            var r = AvroContainer.CreateReader<ClassOfInt>(this.resultStream, true, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, new CodecFactory());
            using (var reader = new SequentialReader<ClassOfInt>(r))
            {
        ...
        public void SequentialWriter_MicrosoftWriterApacherReaderOfNestedType()
        {
            ...
            var w = AvroContainer.CreateWriter<NestedClass>(this.resultStream, new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) }, Codec.Deflate);
