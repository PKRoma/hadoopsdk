    ...
    public sealed class JsonSchemaTests
    {
        ...
        public void JsonSchemaBuilder_BuildEnumSchemaUsingPublicMemberContractResolverWithCSharpNulls()
        {
            const string Expected =
                "{" +
                    "\"type\":\"enum\"," +
                    "\"name\":\"Microsoft.Hadoop.Avro.Specifications.RandomEnumeration\"," +
                    "\"symbols\":" + "[" +
                        "\"Value0\"," +
                        "\"Value1\"," +
                        "\"Value2\"," +
                    ...
                    "{" +
                        ...
                        "\"fields\":" +
                                "[" +
                                    ...
                                    "{\"name\":\"RecursiveField\",\"type\":[\"null\",\"Microsoft.Hadoop.Avro.Specifications.Recursive\"]}" +
                                "]" +
                    "}" +
                "]";
        ...
        public void JsonSchemaBuilder_BuildRecordSchemaWithAliases()
        {
            const string InputJson =
                "{" +
                    "\"type\":\"record\"," +
                    "\"name\":\"Microsoft.Hadoop.Avro.Specifications.SomeRecord\"," +
            ...
            Assert.AreEqual("Microsoft.Hadoop.Avro.Specifications.Alternative1", schema.Aliases[0]);
            Assert.AreEqual("Microsoft.Hadoop.Avro.Specifications.Alternative2", schema.Aliases[1]);
        }
        ...
        public void JsonSchemaBuilder_BuildRecordSchemaForClassWithListFieldUsingPublicMemberContractResolverWithCSharpNulls()
        {
            const string Expected =
                "[" +
                    ...
                    "{" +
                        "\"type\":\"record\"," +
                        "\"name\":\"Microsoft.Hadoop.Avro.Specifications.ClassOfListOfGuid\"," +
                        "\"fields\":[" +
                            "{" +
                                "\"name\":\"ListOfGuid\"," +
                                "\"type\":[" +
        ...
        private static object SerializeRoundTrip(string schema, object obj)
        {
            ...
            {
                var serializer = AvroSerializer.CreateGeneric<object>(schema);
