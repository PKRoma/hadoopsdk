...
namespace Microsoft.Hadoop.Avro.Specifications
{
    ...
    public class SchemaDefaultValuesTests
    {
        ...
        public void SchemaDefaultValues_Record()
        {
            ...
            IAvroSerializer<AvroRecord> tempSerializer = AvroSerializer.CreateGeneric<AvroRecord>(DefaultSchema);
        ...
        public void SchemaDefaultValues_Enum()
        {
            ...
            var tempSerializer = AvroSerializer.CreateGeneric<AvroEnum>(DefaultSchema);
        ...
        public void SchemaDefaultValues_RecordWithInvalidFields()
        {
            const string DefaultSchema =
                @"{""type"":""record"",""name"":""SomeRecord"",""fields"":[{""name"":""Field1"",""type"":""int""}, {""name"":""Field2"", ""type"":""string""}]}";
            var tempSerializer = AvroSerializer.CreateGeneric<AvroRecord>(DefaultSchema);
            dynamic defaultValue = new AvroRecord(tempSerializer.WriterSchema);
            defaultValue.Field1 = Utilities.GetRandom<int>(false);
        ...
        public void SchemaDefaultValues_RecordWithIntFieldHavingDefaultValue()
        {
            ...
            IAvroSerializer<AvroRecord> serializer = AvroSerializer.CreateGeneric<AvroRecord>(WriterSchema);
            IAvroSerializer<AvroRecord> deserializer = AvroSerializer.CreateGenericDeserializerOnly<AvroRecord>(WriterSchema, WriterSchema);
            ...
            Action<dynamic, dynamic> check)
        {
            ...
            var serializer = AvroSerializer.CreateGeneric<AvroRecord>(SimpleIntClassRecordSchema);
            var deserializer = AvroSerializer.CreateGenericDeserializerOnly<AvroRecord>(SimpleIntClassRecordSchema, readerSchema);
