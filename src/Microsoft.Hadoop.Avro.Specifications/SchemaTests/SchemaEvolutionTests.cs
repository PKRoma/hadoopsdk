...
namespace Microsoft.Hadoop.Avro.Specifications
{
    ...
    public sealed class SchemaEvolutionTests
    {
        ...
        {
            this.dataContractSettings = new AvroSerializerSettings { Resolver = new Avro.AvroDataContractResolver() };
        }
        ...
        public void SchemaEvolution_ArrayWithIdenticalElementType()
        {
            ...
            var serializer = AvroSerializer.CreateGeneric<int[]>(WriterSchema);
        ...
        public void SchemaEvolution_RecordWithIdenticalFields()
        {
            const string WriterSchema = @"{
                             ""type"":""record"",
                             ""name"":""Microsoft.Hadoop.Avro.Specifications.ClassOfInt"",
                             ""fields"":
                                       [
            ...
            using (var stream = new MemoryStream())
            {
                ...
                Assert.IsTrue(RecordSerializerTests.ShallowlyEqual(expected, actual));
            }
        }
        ...
        public void SchemaEvolution_RecordWithAliasRelativeToNamespace()
        {
            ...
            const string ReaderSchema =
                        @"{
                            ""type"":""record"",
                            ""name"":""Microsoft.Hadoop.Avro.Specifications.IntClassNewName"",
        ...
        public void SchemaEvolution_RecordWithFullyQualifiedAlias()
        {
            ...
            const string ReaderSchema =
                        @"{
                            ""type"":""record"",
                            ""name"":""Microsoft.Hadoop.Avro.Specifications.IntClassNewName"",
                            ""aliases"":[""Microsoft.Hadoop.Avro.Specifications.SimpleIntClass""],
                            ""fields"":
                                    [
                                        {""name"":""IntField"",""type"":""int""},
                                    ]
        ...
        public void SchemaEvolution_CompatibleConversionOfFixedRecordToGuid()
        {
            ...
            var serializer = AvroSerializer.CreateGeneric<byte[]>(WriterSchema);
        ...
        public void SchemaEvolution_IncompatibleReaderAndWriterValueTypes()
        {
            ...
            AvroSerializer.CreateGeneric<AvroRecord>(WriterSchema);
