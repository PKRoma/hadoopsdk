...
namespace Microsoft.Hadoop.Avro.Specifications
{
    ...
    public sealed class AvroSerializerTests
    {
        ...
        public void Serializer_SerializeClassOfIntDictionaryWithRecursiveType()
        {
            ...
            {
                { ClassOfInt.Create(true), Recursive.Create() },
                { ClassOfInt.Create(true), Recursive.Create() }
            };
        ...
        public void Serializer_MultithreadSerializationRecursiveType()
        {
            ...
            var failed = 0;
            var serializer = AvroSerializer.Create<Recursive>(new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) });
        ...
        public void Serializer_MultithreadedSerialization()
        {
            ...
            var s = AvroSerializer.Create<SimpleFlatClass>(new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) });
        ...
        public void Serializer_SerializeNonDataContractClassUsingDataContractResolver()
        {
            try
            {
                var serializer = AvroSerializer.Create<ClassWithFields>(
            ...
            {
                Assert.IsTrue(ex.Message.Contains("Type 'Microsoft.Hadoop.Avro.Specifications.ClassWithFields' is not supported by the resolver."));
            }
        }
        ...
        public void Serializer_SerializeDataContractClassUsingDataContractResolver()
        {
            ...
            var settings = new AvroSerializerSettings { Resolver = new AvroDataContractResolver() };
        ...
        public void Serializer_SerializeInheritedClassWithWithPublicMembersResolver()
        {
            ...
            var actual = RoundTripSerializationWithCheck(expected);
        ...
        public void Serializer_SerializeClassWithoutParameterlessConstructor()
        {
            ...
            var settings = new AvroSerializerSettings { Surrogate = new Surrogate(), Resolver = new AvroPublicMemberContractResolver(true) };
        ...
        [SuppressMessage("Microsoft.Usage", "CA1806:DoNotIgnoreMethodResults",
            Justification = "This test checks expects in the constructor.")]
        ...
        [TestCategory("CheckIn")]
        [ExpectedException(typeof(SerializationException))]
        public void Serializer_SerializeNonDataContractClass()
        {
            var settings = new AvroSerializerSettings { Resolver = new AvroDataContractResolver() };
            AvroSerializer.Create<NonDataContractClassWithFields>(settings);
        }
        ...
        public void Serializer_SerializeClassWithAbstractAndInterfaceMembersUsingDataContractKnownTypes()
        {
            ...
            RoundTripSerializationWithCheck(
                expected,
                new AvroSerializerSettings { Resolver = new AvroDataContractResolver(), KnownTypes = new HashSet<Type> { typeof(ClassImplementingInterface) } });
        }
        ...
        {
            AvroSerializer.Create<AbstractClassWithInvalidKnownTypes>(new AvroSerializerSettings { Resolver = new AvroDataContractResolver() });
        }
        ...
        public void Serializer_SerializeConcreteBaseClassUsingKnownTypesInSettings()
        {
            ...
            RoundTripSerializationWithCheck(
                ...
                {
                    Resolver = new AvroDataContractResolver(),
                    KnownTypes = new HashSet<Type> { typeof(SquareInheritingConcreteConcreteShape) }
                });
        }
        ...
        {
            var settings = new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(false) };
            var expected = ClassWithFields.Create();
            RoundTripSerializationWithCheck(expected, settings);
        }
        ...
        {
            var settings = new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) };
            var expected = ClassWithSchemaNullableField.Create();
            RoundTripSerializationWithCheck(expected, settings);
        }
        ...
        {
            return AvroSerializer.Create<T>();
        }
        ...
        private static TS RoundTripSerializationWithCheck<TS>(TS serialized, Action<TS> check, AvroSerializerSettings settings = null)
        {
            ...
            var serializer = settings == null
                ? AvroSerializer.Create<TS>(new AvroSerializerSettings { Resolver = new AvroPublicMemberContractResolver(true) })
