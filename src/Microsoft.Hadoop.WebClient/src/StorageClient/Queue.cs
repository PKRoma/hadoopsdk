...
namespace Microsoft.Samples.ServiceHosting.StorageClient
{
    ...
    public abstract class QueueStorage
    {
        ...
        protected internal QueueStorage(StorageAccountInfo accountInfo)
        {
        ...
        protected internal StorageAccountInfo AccountInfo { get; set; }
        protected internal SharedKeyCredentials Credentials { get; set; }
    }
    ...
    [SuppressMessage("Microsoft.Design", "CA1003:UseGenericEventHandlerInstances",
       Justification = "Suppressing for now as this project is being removed. [tgs]")]
    ...
    public abstract class MessageQueue
    {
        ...
        /// </summary>
        protected internal MessageQueue()
        {
            // queues are generated using factory methods
        }

        protected internal MessageQueue(string name, StorageAccountInfo account)
        {
