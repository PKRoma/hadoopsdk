...
namespace Microsoft.Samples.ServiceHosting.StorageClient
{
    ...
    public abstract class BlobStorage
    {
        ...
        protected internal BlobStorage(Uri baseUri,
                            bool? usePathStyleUris,
                            string accountName,
                            string base64Key
                            )
    ...
    public abstract class BlobContainer
    {
        ...
        protected internal BlobContainer(Uri baseUri, string accountName,  string containerName)
        ...
        protected internal BlobContainer(Uri baseUri, bool usePathStyleUris, string accountName, string containerName, DateTime lastModified)
        {
